...
import Ic_heart from '@svg/ic_tag_heart.svg?react';
import Ic_book from '@svg/ic_tag_book.svg?react';
import Ic_car from '@svg/ic_tag_car.svg?react';
import Ic_clothes from '@svg/ic_tag_clothes.svg?react';
import Ic_digital from '@svg/ic_tag_digital.svg?react';
import Ic_house from '@svg/ic_tag_house.svg?react';
import Ic_infant from '@svg/ic_tag_infant.svg?react';
import Ic_kitchen from '@svg/ic_tag_kitchen.svg?react';
import Ic_sport from '@svg/ic_tag_sport.svg?react';
